...
public interface CrudMealRepository extends JpaRepository<Meal, Integer> {
    ...
    @Query("SELECT m FROM Meal m WHERE m.user.id=:userId AND m.dateTime=:dateTime")
    Meal getMealByUserIdAndDateTime(@Param("userId") int userId, @Param("dateTime") LocalDateTime dateTime);
}